...
def get_resource_change_version(
    ...
    **kwargs
    ...
    """
        ...
        TODO:
            - There should be only one concurrent run at a time. Add wait for finish.
            - What should we do about overlapping intervals?
            - For log-keeping, we should mark runs as full-refresh or incremental.
            - Consider how change versions will work in multi-year systems.
    """
